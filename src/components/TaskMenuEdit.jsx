...
const TaskMenuEdit = ({ onEditTask, onDeleteTask, id }) => {
  ...
  return (
    <div className='edit__menu'>
      <button className="menu__button" title='Editar tarea' onClick={() => setModalEditTaskOpen(true)}>
        <BorderColorIcon />
      </button>
      <button className="menu__button" title='Eliminar tarea' onClick={() => setModalDeleteTaskOpen(true)}>
        <DeleteForeverIcon />
      </button>
