  ...
  return (
    <>
      <main className="formulario-cuenta">
        <Helmet>
          <title>WorkHive - Contacta con nosotros</title>
          <meta name="description" content="Página de contacto de WorkHive" />
        </Helmet>
              ...
              <form onSubmit={handleSubmit} className="principal__formulario">
                ...
                <label htmlFor="subject" className="formulario__label">
                  ...
                  {errors.subject && touched.subject && (
                    <p className="formulario__error">*{errors.subject}</p>
                  )}
                </label>
                ...
                <label htmlFor="accept" className="formulario__label-checkbox">
                  ...
                  />
                  Acepto los términos legales, la política de privacidad y las
                  condiciones de este sitio web.
                  {errors.accept && touched.accept && (
                    <p className="formulario__error">*{errors.accept}</p>
                  )}
                </label>
